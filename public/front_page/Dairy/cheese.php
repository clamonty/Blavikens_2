...
<?php include("../../../resources/templates/front/productLogin.php"); ?>
    ...
    <ol class="breadcrumb bg-white">
      ...
      <li class="breadcrumb-item">
        <a class="text-dark" href="./dairy.php">Dairy</a>
      </li>
      <li class="breadcrumb-item active">Cheese</li>
    </ol>

    <!-- ITEM DESCRIPTION -->
    <div class="section row d-flex justify-content-center">
      <div class="col-md-4 item-img">
        <img src="./img/dairy/cheese.jpg" alt="" class="img-fluid">
      </div>
      <div class="col-md-6 item-description">
        <h2 class="mb-4 text-center">Cheese</h2>
        <h3 class="mb-3 text-center">
          <span class="font-weight-bold total-price" data-price="8.99">Test</span>
        ...
        <div id="accordion" class="mb-5 w-75 mx-auto">
          <div class="card">
            ...
            >
              <div class="card-body px-3">Finely aged and marbled</div>
            </div>
          </div>
        </div>
        ...
        <div class="input-group mb-3 item-count w-50 mx-auto">
          <div class="input-group-prepend">
            <button class="btn btn-outline-secondary" type="button">
              <i class="fas fa-minus decrease-btn"></i>
            </button>
          </div>
