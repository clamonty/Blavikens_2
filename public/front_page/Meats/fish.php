...
<?php include("../../../resources/templates/front/productLogin.php"); ?>
    ...
    <ol class="breadcrumb bg-white">
      ...
      <li class="breadcrumb-item active">Salmon</li>
    </ol>

    <!-- ITEM DESCRIPTION -->
    <div class="section row d-flex justify-content-center">
      <div class="col-md-4 item-img">
        <img src="./img/meat/fish.jpg" alt="" class="img-fluid">
      </div>
      <div class="col-md-6 item-description">
        <h2 class="mb-4 text-center">Salmon</h2>
        <h3 class="mb-3 text-center">
          <span class="font-weight-bold total-price" data-price="15.99">Test</span>
        ...
        <div id="accordion" class="mb-5 w-75 mx-auto">
          <div class="card">
            ...
            >
              <div class="card-body px-3">From the line</div>
            </div>
          </div>
        </div>
