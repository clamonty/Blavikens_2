...
<?php include("../../../resources/templates/front/productLogin.php"); ?>
    ...
    <ol class="breadcrumb bg-white">
      ...
      <li class="breadcrumb-item">
        <a class="text-dark" href="./meats.php">Meat</a>
      </li>
      <li class="breadcrumb-item active">Bacon</li>
    </ol>

    <!-- ITEM DESCRIPTION -->
    <div class="section row d-flex justify-content-center">
      <div class="col-md-4 item-img">
        <img src="./img/meat/bacon.jpg" alt="" class="img-fluid">
      </div>
      <div class="col-md-6 item-description">
        <h2 class="mb-4 text-center">Bacon</h2>
        <h3 class="mb-3 text-center">
          <span class="font-weight-bold total-price" data-price="7.99">Test</span>
        ...
        <div id="accordion" class="mb-5 w-75 mx-auto">
          <div class="card">
            ...
            >
              <div class="card-body px-3">Grass fed and delicious</div>
            </div>
          </div>
        </div>
        ...
        <div class="input-group mb-3 item-count w-50 mx-auto">
          ...
          <input type="text" class="form-control text-center item-quantity" id="item-counter" onchange='saveValue(this);' value="0" placeholder="0"/>
        ...
        <button type="button" class="btn btn-dark text-center w-50 mx-auto d-block"
          ><i class="fas fa-shopping-cart"></i> Add to cart</buttonclass=
        >
      </div>
    </div>
