...
<?php include("../../../resources/templates/front/productLogin.php"); ?>
    ...
    <ol class="breadcrumb bg-white">
      ...
      <li class="breadcrumb-item active">Tiramisu</li>
    </ol>

    <!-- ITEM DESCRIPTION -->
    <div class="section row d-flex justify-content-center">
      <div class="col-md-4 item-img">
        <img src="./img/baked goods/tiramisu.jpg" alt="" class="img-fluid">
      </div>
      <div class="col-md-6 item-description">
        <h2 class="mb-4 text-center">Tiramisu</h2>
        <h3 class="mb-3 text-center">
          <span class="font-weight-bold total-price" data-price="10.99">Test</span>
