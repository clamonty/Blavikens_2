...
<?php include("../../../resources/templates/front/productLogin.php"); ?>
    ...
    <ol class="breadcrumb bg-white">
      ...
      <li class="breadcrumb-item">
        <a class="text-dark" href="./grains.php">Grains & Pasta</a>
      </li>
      <li class="breadcrumb-item active">Brown Bread</li>
    </ol>

    <!-- ITEM DESCRIPTION -->
    <div class="section row d-flex justify-content-center">
      <div class="col-md-4 item-img">
        <img src="./img/grains/brownbread.jpg" alt="" class="img-fluid">
      </div>
      <div class="col-md-6 item-description">
        <h2 class="mb-4 text-center">Brown Bread</h2>
        <h3 class="mb-3 text-center">
          <span class="font-weight-bold total-price" data-price="5.99">Test</span>
        ...
        <div id="accordion" class="mb-5 w-75 mx-auto">
          <div class="card">
            ...
            >
              <div class="card-body px-3">Whole grain, baked in house</div>
            </div>
          </div>
        </div>
