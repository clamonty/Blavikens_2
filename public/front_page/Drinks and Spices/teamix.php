...
<?php include("../../../resources/templates/front/productLogin.php"); ?>
    ...
    <ol class="breadcrumb bg-white">
      ...
      <li class="breadcrumb-item">
        <a class="text-dark" href="./dairy.php">Drinks & Spices</a>
      </li>
      <li class="breadcrumb-item active">Tea Mix</li>
    </ol>

    <!-- ITEM DESCRIPTION -->
    <div class="section row d-flex justify-content-center">
      <div class="col-md-4 item-img">
        <img src="./img/drinks and spices/teamix.jpg" alt="" class="img-fluid">
      </div>
      <div class="col-md-6 item-description">
        <h2 class="mb-4 text-center">Tea Mix</h2>
        <h3 class="mb-3 text-center">
          <span class="font-weight-bold total-price" data-price="9.99">Test</span>
        ...
        <div id="accordion" class="mb-5 w-75 mx-auto">
          <div class="card">
            ...
            >
              <div class="card-body px-3">Lightly spiced and refreshing</div>
            </div>
          </div>
        </div>
